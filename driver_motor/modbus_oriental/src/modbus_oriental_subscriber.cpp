 ...
 */
ORIENTAL_MOTOR::Subscriber::Subscriber(ros::NodeHandle & nh, const std::string & ros_topic, int subscribe_queue_size, double max_publish_delay)
 ...
 * Destructor.
 */
ORIENTAL_MOTOR::Subscriber::~Subscriber()
{
 ...
 */
void ORIENTAL_MOTOR::Subscriber::init(double schedule_publish_delay)
{
 ...
 */
bool ORIENTAL_MOTOR::Subscriber::subscriberTopics(void)
{
   control_wheel = nh_.subscribe(topic_name_, m_subscribe_queue_size_, &ORIENTAL_MOTOR::Subscriber::cmd_velCallback, this);
}
 ...
 */
bool ORIENTAL_MOTOR::Subscriber::isSpeed_wheelTriggered(void)
{
 ...
 */
bool ORIENTAL_MOTOR::Subscriber::ispublishTriggeredOverTime(void)
{
   boost::lock_guard<boost::mutex> schedule_lockguard(pulish_mutex);
 ...
 */
void ORIENTAL_MOTOR::Subscriber::schedulePublishControlWheel(bool schedule)
{
   boost::lock_guard<boost::mutex> schedule_lockguard(pulish_mutex);
...
*/
void ORIENTAL_MOTOR::Subscriber::publishTriggerControlWheel(void)
{
...
*/
void ORIENTAL_MOTOR::Subscriber::cmd_velCallback(const nav_converter::speed_wheelPtr & msg)
{
