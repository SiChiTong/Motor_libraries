 ...
 */
GGM::Diagnostic::DiagnosticImpl GGM::Diagnostic::g_diagnostic_handler;


/*
 * Constructor.
 */
GGM::Diagnostic::DiagnosticImpl::DiagnosticImpl() : m_diagnostic_initialized(false), m_diagnostic_component("")
{
}
 ...
 */
void GGM::Diagnostic::DiagnosticImpl::init(ros::NodeHandle &nh, const std::string & publish_topic, const std::string & component)
{
 ...
 */
void GGM::Diagnostic::DiagnosticImpl::update(DIAGNOSTIC_STATUS status, const std::string &message)
{
